...
class Visualizer(BaseVisualizer):
    ...
    def generate_confusion_matrix(self, labels, true, prediction, normalize):
        ...
        if normalize:
            ...
            row_sums[row_sums == 0] = 1  #0-val való osztás elkerülése
    ...
    def plot_metrics_F1_recall_accuracy_precision(self, true, pred):
        ...
        #Igaz és prediktált adatok kinyerése
        ...
        #Precision értékek kinyerése és ábrázolása
        ...
        #Recall értékek kinyerése és ábrázolása
        ...
        #F1 értékek kinyerése és ábrázolása
