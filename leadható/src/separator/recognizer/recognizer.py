...
#Ez végzi a karakterek felismerését
#64x64-es szürkeárnyalatos képeket ismer fel, 
#és adja vissza a képhez tartozó betűt
#Egy számot ad vissza, ezt kell mappelni a betűkhöz, ezt végzi el a mapping_json
